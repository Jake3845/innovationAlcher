...
public class LowAlchemy extends Node implements MessageListener{
	
	@Override
	public void execute() {
		Methods.antiban();
		if (Tabs.MAGIC.isOpen()) {
			if (Variables.lowAlchemySpell != null) {
				Variables.lowAlchemySpell.click(true);
				sleep(500,700);
	...
	public boolean activate() {
		return Skills.getLevel(6) >= 21 && Game.isLoggedIn()
